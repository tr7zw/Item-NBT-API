 ...
 * This class doesn't autosave to the Itemstack, use getItem to get the changed ItemStack
 * 
 * @author tr7zw
 *
 */
public class NBTItem extends NBTCompound {
    ...
    /**
     * Helper method that converts {@link ItemStack} to {@link NBTContainer} with all it's data like Material, Damage, Amount and Tags.
     * 
     * @param item
    ...
    /**
     * Helper method to do the inverse to "convertItemtoNBT". Creates an {@link ItemStack} using the {@link NBTCompound}
     * 
     * @param comp
