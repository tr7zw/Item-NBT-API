...
/**
 * Base class representing NMS Compounds. For a standalone implementation check {@link NBTContainer}
 * 
 * @author tr7zw
 *
 */
public class NBTCompound {
    ...
    /**
     * Merges all data from comp into this compound. This is done in one action, so it also works with Tiles/Entities
     * 
     * @param comp
     */
